...
function insideuwp_theme_name_scripts() {
	...
	wp_enqueue_script( 'analytics', get_stylesheet_directory_uri() . '/js/analytics.js', array(), false, true );
	wp_enqueue_script( 'webfont', 'https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js', array('jquery'), false, true );
}
