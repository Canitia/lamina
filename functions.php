...
function lamina_pagination_numeric_posts_nav() {
	...
	if ( get_previous_posts_link() )
		printf( '<li>%s</li>' . "\n", esc_html_e(get_previous_posts_link('<i class="fa fa-chevron-left" aria-hidden="true"></i>'),'lamina') );

	/**	Link to first page, plus ellipses if necessary */
	if ( ! in_array( 1, $links ) ) {
		$class = 1 == $paged ? ' class="active"' : '';

		printf( '<li%s><a href="%s">%s</a></li>' . "\n", esc_html_e($class,'lamina'), get_pagenum_link( 1, true ), '1' );
	...
	foreach ( (array) $links as $link ) {
		...
		printf( '<li%s><a href="%s">%s</a></li>' . "\n", esc_html_e($class,'lamina'), get_pagenum_link( $link, 1, true ), $link );
	}
	...
	if ( ! in_array( $max, $links ) ) {
		...
		printf( '<li%s><a href="%s">%s</a></li>' . "\n", esc_html_e($class,'lamina'), get_pagenum_link( $max, 1, true ), $max );
	}
