...
function insideuwp_theme_name_scripts() {
	...
	wp_enqueue_script( 'materialize', get_stylesheet_directory_uri() . '/js/materialize.min.js', array('jquery'), false );
	wp_enqueue_script( 'sidenav', get_stylesheet_directory_uri() . '/js/sidenav.js', array('jquery', 'materialize'), false );
}
