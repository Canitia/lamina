...
?>/images/no-pic-available.jpg" alt="<?php the_title_attribute();
...
?>
                                                  ...
                                                  <span class="card-title">
                                                    <p class="posttitle"><a href="<?php the_permalink();
?>" title="<?php the_title_attribute();
?>"><?php the_title();
?></a></p>
                                                    </span>
                                                ...
                                                <div class="card-content">
                                                  <p class="postdate center-align">
                                                    <i class="fa fa-clock-o"></i><time><?php echo get_the_date();
?></time>
...
?></p>
                                      ...
                                      <?php endwhile;
                                  		      ...
                                  		      <p><?php echo wpautop( 'Sorry, this category can not be found' );
?></p>
                                      <?php endif;
?>
...
?>
                                      ...
                                      <li class="active"><?php $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
echo $paged;
?></li>
